Feature: User Login
  ...
  Scenario: Login attempt with empty fields
    ...
    Then Username field displays the error message "Username is required"
    And Password field displays the error message "Password is required"
  ...
  Scenario: Login attempt with valid username and invalid password
    ...
    And User clicks the login button
    Then User should see an error message "Username or Password is incorrect."
